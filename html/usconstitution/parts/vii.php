...
<head>
    <title>The United States Constitution: Article VII</title>
        ...
        <div class="row">
           <?php include("include/navigation.php"); ?>
            <div class="nine columns">
                <main>
                    <h2>Article. VII</h2> The Ratification of the Conventions of nine States, shall be sufficient for the Establishment of this Constitution between the States so ratifying the Same.
